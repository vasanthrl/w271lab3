...
table(data$state)
```
The dataframe has 1200 observations, with 56 columns from year 1980 to 2004. The data has 25 observations each from 48 states except state ids 2,3 and 9. There are no missing data.
