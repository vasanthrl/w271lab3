...
year.plot <- ggplot(traffic.yearly.aggr, aes(year, totfatrte)) +
  ...
  theme(plot.title = element_text(size = 10, hjust = 0.5)) + theme(legend.position = "none") + labs (x = "") + labs (x = "",y= "Fatality Rate")
...
state.plot <- ggplot(traffic.state.perc.aggr, aes(shortname, totfatrte)) +
  ...
  theme(plot.title = element_text(size = 10, hjust = 0.5)) + theme(legend.position = "none") + geom_text(data = traffic.state.perc.aggr, aes(x = shortname, y = totfatrte, label = round(totfatrte,1)), size = 3,angle = 90, position = position_stack(vjust = .5)) + labs (x = "",y= "Fatality Rate")
...
#TODO write out the model in text
