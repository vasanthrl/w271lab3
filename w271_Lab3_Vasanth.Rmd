...
*totfatrte* defines the total fatalities per 100,000 population.
...
Both the variables *bac10* and *bac08* have the negative coefficients of -2.498 and -1.418 respectively. They are statistically significant and it implies that they have a strong negative correlation to the total fatality rate.
...
pnldata <- plm.data(drivingdf, c("state", "year"))
